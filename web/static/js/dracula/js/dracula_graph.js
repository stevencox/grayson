...
Graph.Renderer.Raphael.prototype = {
	...
	// scox
        ...
        this.factorX = (this.width - 15 * this.radius) / (this.graph.layoutMaxX - this.graph.layoutMinX);
        this.factorY = (this.height - 7 * this.radius) / (this.graph.layoutMaxY - this.graph.layoutMinY);
